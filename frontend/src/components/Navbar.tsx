...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between w-full border-b border-gray-400 py-8 px-4">
        <img
          src={navImg}
          alt="logo"
        />
        <nav>
          ...
          <section className="MOBILE-MENU flex lg:hidden">
            ...
            <div className={isNavOpen ? "showMenuNav" : "hideMenuNav "}>
              <div
                className="absolute top-0 right-0 px-4 py-8 flex justify-between w-full"
